...
import numpy as np
from src.cifar10.macro_child import tf
...
class TestMacroChild(unittest.TestCase):
    ...
    @patch('src.cifar10.models.Model.__init__')
    @patch('src.cifar10.macro_child.create_weight')
    @patch('src.cifar10.macro_child.tf.nn.conv2d', return_value=None)
    ...
    @patch('src.cifar10.models.Model.__init__')
    @patch('src.cifar10.macro_child.create_weight', return_value="w")
    @patch('src.cifar10.macro_child.tf.nn.conv2d', return_value="conv2d")
    @patch('src.cifar10.macro_child.tf.nn.avg_pool', return_value="path1")
    @patch('src.cifar10.macro_child.tf.pad', return_value=np.ndarray((5, 5, 5, 5)))
    @patch('src.cifar10.macro_child.tf.concat', return_value="final_path")
    ...
    @patch('src.cifar10.macro_child.tf.nn.dropout')
    ...
    @patch('src.cifar10.macro_child.batch_norm', return_value="final_path")
    @patch('src.cifar10.macro_child.global_avg_pool', return_value="global_avg_pool")
    @patch('src.cifar10.macro_child.tf.nn.dropout', return_value=tf.constant(np.ndarray((4, 3, 32, 32))))
    @patch('src.cifar10.macro_child.tf.matmul')
    ...
    @patch('src.cifar10.models.Model.__init__')
    @patch('src.cifar10.macro_child.tf.case', return_value=tf.constant(np.ndarray((4, 32, 32, 24)), tf.float32))
    @patch('src.cifar10.macro_child.tf.add_n', return_value="add_n")
    ...
    @patch('src.cifar10.models.Model.__init__')
    @patch('src.cifar10.macro_child.tf.case', return_value=tf.constant(np.ndarray((4, 24, 32, 32)), tf.float32))
    @patch('src.cifar10.macro_child.tf.add_n', return_value="add_n")
    @patch('src.cifar10.macro_child.batch_norm', return_value="batch_norm")
    ...
    @patch('src.cifar10.models.Model.__init__')
    @patch('src.cifar10.macro_child.tf.concat', return_value="concat")
    @patch('src.cifar10.macro_child.tf.nn.conv2d', return_value="conv2d")
    @patch('src.cifar10.macro_child.tf.nn.relu', return_value="relu")
    @patch('src.cifar10.macro_child.batch_norm', return_value="batch_norm")
    @patch('src.cifar10.macro_child.tf.add_n', return_value="add_n")
    ...
    @patch('src.cifar10.macro_child.batch_norm', return_value="batch_norm")
    @patch('src.cifar10.macro_child.tf.add_n', return_value="add_n")
    @patch('src.cifar10.macro_child.create_weight', return_value="create_weight")
    @patch('src.cifar10.macro_child.tf.logical_and', return_value="logical_and")
    @patch('src.cifar10.macro_child.tf.logical_or', return_value="logical_or")
    @patch('src.cifar10.macro_child.tf.boolean_mask', return_value="boolean_mask")
    @patch('src.cifar10.macro_child.tf.reshape', return_value="reshape")
    @patch('src.cifar10.macro_child.tf.shape', return_value=["shape"])
    ...
    @patch('src.cifar10.models.Model.__init__')
    @patch('src.cifar10.macro_child.tf.nn.conv2d', return_value="conv2d")
    @patch('src.cifar10.macro_child.create_weight', return_value=tf.Variable(initial_value=np.zeros((24, 24, 24, 1))))
    @patch('src.cifar10.macro_child.batch_norm', return_value="batch_norm")
    @patch('src.cifar10.macro_child.tf.nn.relu', return_value="relu")
    @patch('src.cifar10.macro_child.tf.transpose', return_value="transpose")
    @patch('src.cifar10.macro_child.tf.reshape', return_value="reshape")
    @patch('src.cifar10.macro_child.tf.nn.separable_conv2d', return_value="sep_conv2d")
    ...
    @patch('src.cifar10.macro_child.batch_norm', return_value="batch_norm")
    @patch('src.cifar10.macro_child.tf.nn.relu', return_value="relu")
    @patch('src.cifar10.macro_child.tf.transpose', return_value=tf.Variable(initial_value=np.zeros((24, 24, 24, 1))))
    @patch('src.cifar10.macro_child.tf.reshape', return_value="reshape")
    @patch('src.cifar10.macro_child.tf.nn.separable_conv2d', return_value="sep_conv2d")
    @patch('src.cifar10.macro_child.batch_norm_with_mask', return_value="bnwm")
    ...
    @patch('src.cifar10.macro_child.batch_norm', return_value="batch_norm")
    @patch('src.cifar10.macro_child.tf.nn.relu', return_value="relu")
    @patch('src.cifar10.macro_child.tf.compat.v1.layers')
    @patch('src.cifar10.macro_child.create_weight', return_value=tf.Variable(initial_value=np.zeros((24, 24, 24, 1))))
    ...
    @patch('src.cifar10.models.Model.__init__')
    @patch('src.cifar10.macro_child.tf.reduce_sum', return_value="reduce_sum")
    @patch('src.cifar10.macro_child.tf.equal', return_value="equal")
    @patch('src.cifar10.macro_child.tf.compat.v1.to_int32', return_value="to_int32")
    @patch('src.cifar10.macro_child.print')
    @patch('src.cifar10.macro_child.tf.nn.sparse_softmax_cross_entropy_with_logits', return_value="sscewl")
    @patch('src.cifar10.macro_child.tf.reduce_mean', return_value="reduce_mean")
    @patch('src.cifar10.macro_child.tf.argmax', return_value=10)
    ...
    @patch('src.cifar10.models.Model.__init__')
    @patch('src.cifar10.macro_child.print')
    @patch('src.cifar10.macro_child.tf.argmax', return_value="argmax")
    @patch('src.cifar10.macro_child.tf.compat.v1.to_int32', return_value="to_int32")
    @patch('src.cifar10.macro_child.tf.equal', return_value="equal")
    @patch('src.cifar10.macro_child.tf.reduce_sum', return_value="reduce_sum")
    ...
    @patch('src.cifar10.models.Model.__init__')
    @patch('src.cifar10.macro_child.tf.map_fn', return_value="map_fn")
    @patch('src.cifar10.macro_child.tf.reduce_sum', return_value="reduce_sum")
    @patch('src.cifar10.macro_child.tf.equal', return_value="equal")
    @patch('src.cifar10.macro_child.tf.compat.v1.to_int32', return_value="to_int32")
    @patch('src.cifar10.macro_child.tf.argmax', return_value="argmax")
    @patch('src.cifar10.macro_child.tf.compat.v1.train.shuffle_batch', return_value=(tf.constant(np.ndarray((2, 3, 32, 32))), "y_valid_shuffle"))
    @patch('src.cifar10.macro_child.print')
    ...
    # @patch('src.cifar10.macro_child.tf.compat.v1.train.shuffle_batch')
    # @patch('src.cifar10.main.tf.map_fn')
    # @patch('src.cifar10.macro_child.tf.compat.v1.train.batch')
    ...
    #     mc = MacroChild(mock_images, mock_labels)
    #     self.assertEqual(MacroChild, type(mc))
    #     self.assertEqual(3, mc._get_C(tf.constant(np.zeros((45000, 32, 32, 3)))))
    #     self.assertEqual(32, mc._get_HW(tf.constant(np.zeros((45000, 32, 32, 3)))))
    #     self.assertEqual([1, 2, 2, 1], mc._get_strides(2))
    #     print.assert_any_call("-" * 80)
    ...
    #     map_fn.return_value = mock_images['train']
    #     batch.return_value = (mock_images['train'], mock_labels['train'])
    #     mc = MacroChild(mock_images, mock_labels, data_format="NCHW")
    #     self.assertEqual(MacroChild, type(mc))
    #     self.assertEqual(3, mc._get_C(tf.constant(np.zeros((45000, 3, 32, 32)))))
    #     self.assertEqual(32, mc._get_HW(tf.constant(np.zeros((45000, 3, 32, 32)))))
    #     self.assertEqual([1, 1, 2, 2], mc._get_strides(2))
    #     print.assert_any_call("-" * 80)
    #     print.assert_any_call("Build model child")
    #     print.assert_any_call("Build data ops")
    ...
    #     map_fn.return_value = mock_images['train']
    #     batch.return_value = (mock_images['train'], mock_labels['train'])
    #     mc = MacroChild(mock_images, mock_labels, data_format="INVALID")
    #     self.assertRaises(ValueError, mc._get_strides, 2)
    #     self.assertRaises(ValueError, mc._get_C, tf.constant(np.zeros((45000, 32, 32, 3))))
    ...
    #     batch.return_value = (mock_images['train'], mock_labels['train'])
    #     mc = MacroChild(mock_images, mock_labels)
    #     mc._factorized_reduction(tf.constant(np.zeros((45000, 32, 32, 3)), tf.float32), 2, 1, True)
    ...
    #     batch.return_value = (mock_images['train'], mock_labels['train'])
    #     mc = MacroChild(mock_images, mock_labels)
    #     mc._factorized_reduction(tf.constant(np.zeros((45000, 32, 32, 3)), tf.float32), 2, 2, True)
    ...
    #     mc = MacroChild(mock_images, mock_labels, whole_channels=True, fixed_arc=fixed_arc)
    #     controller = mock.MagicMock()
    #     controller.sample_arc = np.array([int(x) for x in fixed_arc.split(" ") if x])
    #     mc.connect_controller(controller)
    ...
    #     batch.return_value = (mock_images['train'], mock_labels['train'])
    #     fixed_arc = "0 3 0 0 1 0"
    #     mc = MacroChild(mock_images, mock_labels, whole_channels=True, fixed_arc=fixed_arc, keep_prob=0.9)
    #     controller = mock.MagicMock()
    #     controller.sample_arc = np.array([int(x) for x in fixed_arc.split(" ") if x])
    #     mc.connect_controller(controller)
    ...
    #         mc = MacroChild(mock_images, mock_labels, whole_channels=True, fixed_arc=fixed_arc, keep_prob=0.9, data_format="NCHW")
    #         controller = mock.MagicMock()
    #         controller.sample_arc = np.array([int(x) for x in fixed_arc.split(" ") if x])
