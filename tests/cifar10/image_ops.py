...
class TestImageOps(unittest.TestCase):
    ...
    @patch('src.cifar10.image_ops.tf.reduce_mean', return_value="reduce_mean")
    ...
    @patch('src.cifar10.image_ops.tf.compat.v1.keras.initializers.Constant', return_value="constant")
    @patch('src.cifar10.image_ops.tf.compat.v1.get_variable', return_value="get_variable")
    @patch('src.cifar10.image_ops.tf.compat.v1.nn.fused_batch_norm', return_value="fbn")
    @patch('src.cifar10.image_ops.tf.identity', return_value="identity")
    ...
    @patch('src.cifar10.image_ops.tf.control_dependencies')
    @patch('src.cifar10.image_ops.tf.identity', return_value="identity")
    @patch('src.cifar10.image_ops.tf.compat.v1.scatter_sub', return_value="scatter_sub")
    @patch('src.cifar10.image_ops.tf.compat.v1.nn.fused_batch_norm', return_value=("fbn", 1.0, 1.0))
    @patch('src.cifar10.image_ops.tf.boolean_mask', return_value=1.0)
    @patch('src.cifar10.image_ops.tf.compat.v1.get_variable', return_value="get_variable")
    @patch('src.cifar10.image_ops.tf.compat.v1.keras.initializers.Constant', return_value="constant")
    @patch('src.cifar10.image_ops.tf.reshape')
    @patch('src.cifar10.image_ops.tf.compat.v1.to_int32', return_value="to_int32")
    @patch('src.cifar10.image_ops.tf.where', return_value="where")
    ...
    @patch('src.cifar10.image_ops.tf.compat.v1.nn.fused_batch_norm', return_value="fbn")
    @patch('src.cifar10.image_ops.tf.boolean_mask', return_value="boolean_mask")
    @patch('src.cifar10.image_ops.tf.compat.v1.get_variable', return_value="get_variable")
    @patch('src.cifar10.image_ops.tf.compat.v1.keras.initializers.Constant', return_value="constant")
    @patch('src.cifar10.image_ops.tf.reshape')
    @patch('src.cifar10.image_ops.tf.compat.v1.to_int32', return_value="to_int32")
