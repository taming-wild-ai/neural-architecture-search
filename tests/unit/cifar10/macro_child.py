            ...
            with patch.object(mc, '_get_strides', return_value="stride spec") as get_strides:
                with patch.object(mc.data_format, 'get_C', return_value="inp_c") as get_C:
                    with patch.object(mc.weights, 'get', return_value='fw.create_weight') as create_weight:
                        ...
                        batch_norm.assert_called_with('final_path', True, mc.data_format, mc.weights)
            ...
            with patch.object(mc, '_conv_branch', return_value="conv_branch") as conv_branch:
                with patch.object(mc, '_pool_branch', return_value="pool_branch") as pool_branch:
                    with patch.object(mc.weights, 'get', return_value='fw.create_weight') as create_weight:
                        ...
                        pool_branch.assert_called_with(input_tensor, True, 24, 'max', mc.weights, False, start_idx=0)
            ...
            with patch.object(mc, '_conv_branch', return_value="conv_branch") as conv_branch:
                with patch.object(mc, '_pool_branch', return_value="pool_branch") as pool_branch:
                    with patch.object(mc.weights, 'get', return_value='fw.create_weight') as create_weight:
                        ...
                        pool_branch.assert_called_with(input_tensor, True, 0, 'max', mc.weights, False, start_idx=2)
        ...
        with tf.Graph().as_default():
            ...
            with patch.object(mc.weights, 'get', return_value='fw.create_weight') as create_weight:
                with patch.object(mc.data_format, 'get_C', return_value=3) as get_C:
                    ...
                    get_C.assert_called_with(input_tensor)
    ...
    def test_build_train(self, get_train_ops, argmax, reduce_mean, sscewl, print, to_int32, equal, reduce_sum):
        with tf.Graph().as_default():
            ...
            with patch.object(mc, '_model', return_value="model") as model:
                ...
                get_train_ops.assert_called_with('reduce_mean', [], mc.global_step, mc.learning_rate, clip_mode=None, l2_reg=mc.l2_reg, num_train_batches=310, optim_algo=None)
