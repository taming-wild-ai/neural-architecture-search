...
class TestMacroController(unittest.TestCase):
    ...
    @patch('src.cifar10.macro_controller.fw.zeros', return_value="zeros")
    @patch('src.cifar10.macro_controller.print')
    def test_build_trainer(self, print, zeros, variable, get_train_ops, to_float, reshape, sscewl, embedding_lookup, stack_lstm, matmul, multinomial, to_int32, where, concat, reduce_sum, cd):
        ...
        with tf.Graph().as_default() as graph:
            ...
            variable(0.0, dtype=fw.float32).assign_sub.assert_called()
